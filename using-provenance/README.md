...
`--node tcp://localhost:26657` this is the default node location and port.  In the examples below, we'll connect to a remote node without starting a local node.  The remote node is a public testnet node hosted at `https://rpc.test.provenance.io:443.test.provenance.io:26657.`
{% endhint %}
