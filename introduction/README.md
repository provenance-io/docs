...
Large financial institutions, investors, technical leaders, and individuals provide the foundation of security and stability of the Provenance network by staking [Hash](../blockchain/hash-2.0.md)™ as a network [Validator](https://docs.tendermint.com/master/nodes/validators.html) or [delegator](https://hub.cosmos.network/main/delegators/delegator-faq.html).
